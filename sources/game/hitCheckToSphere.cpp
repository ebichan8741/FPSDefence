//================================================================================================
//
// 球の当たり判定確認用 [hitCheckToSphere.cpp]
...
// コンストラクタ
//*************************************************************************************************
CHitCheckSphere::CHitCheckSphere(int nPriolity) :CScene(nPriolity)
{
    m_pTexture = NULL;
    m_Hit = NULL;
...
// 初期化処理
//*************************************************************************************************
HRESULT CHitCheckSphere::Init(void)
{
...
// 終了処理
//*************************************************************************************************
void CHitCheckSphere::Uninit(void)
{
    //頂点バッファーの解放
    if (m_pVtxBuff != NULL)
    {
...
// 更新処理
//*************************************************************************************************
void CHitCheckSphere::Update(void)
{
    if (m_Hit) {
        m_Color = D3DXCOLOR(1.0f, 0.0f, 0.0f, 0.5f);
        m_Hit = false;
...
// 描画処理
//*************************************************************************************************
void CHitCheckSphere::Draw(void)
{
    LPDIRECT3DDEVICE9 pDevice = CManager::GetRenderer()->GetDevice();
...
// 頂点情報の設定
//*************************************************************************************************
HRESULT CHitCheckSphere::MakeVertex(LPDIRECT3DDEVICE9 pDevice)
{
    VERTEX_3D* pVtx;
    int nNumVtx;
...
// 頂点インデックスの設定
//*************************************************************************************************
HRESULT CHitCheckSphere::MakeIndex(LPDIRECT3DDEVICE9 pDevice)
{
    WORD* pIdx;
...
// インスタンス生成
//*************************************************************************************************
CHitCheckSphere *CHitCheckSphere::Create(D3DXVECTOR3 pos, D3DXVECTOR3 size)
{
    CHitCheckSphere *hitdome;

    hitdome = new CHitCheckSphere(PRIOLITY_1);
...
// 座標とサイズの設定
//*************************************************************************************************
void CHitCheckSphere::SetSphere(D3DXVECTOR3 pos, D3DXVECTOR3 size)
{
    m_vPos = pos;
    m_vSize = size;
}
...
// ヒット中
//*************************************************************************************************
void CHitCheckSphere::HitToSphere(void)
{
    m_Hit = true;
}